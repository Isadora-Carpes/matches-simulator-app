package isadora.simulator.ui.adapter;
...
import isadora.simulator.databinding.MatchItemBinding;
import isadora.simulator.domain.Match;
import isadora.simulator.ui.DetailActivity;
...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (match.getHomeTeam().getScore() != null) {
            holder.binding.tvHomeTeamSocre.setText(String.valueOf(match.getHomeTeam().getScore()));
        }
